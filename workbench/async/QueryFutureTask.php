...
class QueryFutureTask extends FutureTask {
    ...
    function displayQueryResults($records, $queryTimeElapsed, QueryRequest $queryRequest) {
        ...
        if (!WorkbenchConfig::get()->value("autoRunQueryMore") && $this->nextQueryLocator) {
            ...
            print "<p><input type='submit' name='queryMore' id='queryMoreButtonTop' class='disableWhileAsyncLoading' value='More...' /></p>\n";
        }
        ...
        if (!WorkbenchConfig::get()->value("autoRunQueryMore") && $this->nextQueryLocator) {
            print "<p><input type='hidden' name='queryLocator' id='queryLocator' value='" . $this->nextQueryLocator . "' /></p>\n";
            print "<p><input type='submit' name='queryMore' id='queryMoreButtonBottom' class='disableWhileAsyncLoading' value='More...' /></p>";
        }
