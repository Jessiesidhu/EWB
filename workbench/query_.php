...
function displayQueryForm($queryRequest) {
    ...
    print "<div class='bodyDiv brdPalette brandPrimaryBrd' id='bodyDiv_setup'>";
print "<table width='100%'>";
print "<tbody>";
print "<tr>";
print "<td class='leftpanel'>";
        print "<div class='local-discovery column' role='complementary'>";
        print "<div class='discovery-block'><div class='developerforce'><span id='content_wrap:devForce'><iframe frameborder='0' class='contentFrame' height='430' width='100%' scrolling='no'></iframe></span></div></div>";
        print "<div class='discovery-block'><div class='developerforce'><span id='content_wrap:apps'><iframe frameborder='0' class='contentFrame' height='200' width='100%' scrolling='no'></iframe></span></div></div>";
        print "</div>";
        print "</td>";
        print "<td class='pageBlock'>"; //Query Form
